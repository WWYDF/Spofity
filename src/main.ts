import { startBot } from "./components/discord/index.js";
...
async function main() {
    ...
    await refreshLogs();
    if (config.bot_token == undefined) { sendLog('critical', 'Bot token is undefined. Please put it in config.json!'); return;}
